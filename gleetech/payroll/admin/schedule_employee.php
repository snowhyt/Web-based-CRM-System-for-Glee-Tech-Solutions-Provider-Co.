...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-clock-o"></i> Printables</a></li>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              <a href="schedule_print_preview" class="btn btn-success"><span class="glyphicon glyphicon-print"></span> Print Preview</a>
            </div>
            <div class="box-body">
                    ...
                    while($row = $query->fetch_assoc()){
                      echo "
                        <tr>
                          ...
                          <td>
                            <button class='btn btn-success btn-sm edit' data-id='".$row['empid']."'><i class='fa fa-edit'></i> Edit</button>
                          </td>
                        </tr>
                      ";
                    }
...
//ajax call to get employee schedule
function getRow(id){
  $.ajax({
    type: 'POST',
