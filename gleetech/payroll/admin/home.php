      ...
      <div class="row">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <?php
                ...
                $percentage = $total=0? 0 : ($early/$total)*100;
            ...
            <a href="attendance?stat=1" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            ...
            <a href="attendance?stat=0" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
      </div>
