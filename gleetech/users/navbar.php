<header class="main-header">
    ...
    <a href="../home" class="logo" style="background-color:#1a2226;">
      ...
      <span class="logo-lg">
        <image src="../payroll/images/icon.png" style="height:35px;width:35px;"></image>
        <b style="font-size:medium;"> User Management</b>
      </span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header" style="background-color:#1e282c;">
                <img src="<?php echo (!empty($user['photo'])) ? '../payroll/images/'.$user['photo'] : '../payroll/images/profile.jpg'; ?>" class="img-circle" alt="User Image">
                <p>
              ...
              <li class="user-footer" style="background-color:lightgray;">
                ...
                <div class="pull-right">
                  <a href="http://localhost/gleetech/home" class="btn btn-default btn-flat">
