    ...
    <div class="container-fluid d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a href="#" style="color:whitesmoke;"><span>Admin Links</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
            <ul>
              <li><a href="../attendance" class="active">Attendance Monitoring</a></li>
              <li><a href="../payroll/admin">Payroll Management</a></li>
              <li><a href="../service_management/">Service Management</a></li>
              <li><a href="../users">User Management</a></li>
            </ul> 
          </li>

          <li><a class="nav-link scrollto" href="signout" style="color:whitesmoke;">Sign-Out</a>         
          </li>
        </ul>
