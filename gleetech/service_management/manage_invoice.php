...
<div class="wrapper">
  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-print"></i> Invoices</a></li>
              ...
              <table id="example1" class="table table-bordered">
               ...
               <tbody>
                 <?php
                    ...
                    $sql = "SELECT requests.request_id, invoice.invoice_id, invoice.service_amount,  CONCAT(admin.firstname,' ',admin.lastname) 'customer_name', services.service_name, requests.paid, (SELECT CONCAT(firstname,' ',lastname) FROM admin WHERE id=invoice.issued_by) 'issued_by', invoice.issued_date FROM invoice LEFT JOIN admin ON invoice.customer_id=admin.id LEFT JOIN requests ON invoice.request_id=requests.request_id LEFT JOIN services ON requests.service_id=services.service_id WHERE invoice.issued_date BETWEEN '$from' AND '$to'";
...
<script type="text/javascript">
  ...
  $('#applyFilter').click(function(){
    ...
    $('#applyFilter').attr('action', 'manage_invoice?range='+range);
    $('#applyFilter').submit();
  });
